...
Second, I examine how digital information flows through and across physical media, developing tangible interfaces and 3D-printed interactive materials that bridge virtual and material environments.<br><br>
...
.thumbnail {
  max-width: 180px;        /* Set a consistent width */
  max-height: 180px;       /* Set a consistent height */
